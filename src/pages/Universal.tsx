  ...
  const handleItemClick = (section: string) => {
    if (!isAuthenticated) {
      toast({
        ...
        description: "Please login to interact with this section",
        variant: "destructive"
      });
      navigate('/auth');
      return;
      ...
      <section className="bg-gradient py-12 md:py-24">
        <div className="container mx-auto px-4 md:px-6 flex flex-col items-center text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
            <span className="text-gradient">Code Commando</span>
          </h1>
          <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mb-8">
            Find lost items, report found items, and donate valuable items to your community
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-full max-w-3xl">
            <Button 
              ...
              onClick={() => handleItemClick("lost-items")}
            >
              Lost Something?
            </Button>
            <Button 
              ...
              onClick={() => handleItemClick("found-items")}
            >
              Found Something?
            </Button>
            <Button 
      ...
      <section className="py-12 md:py-16 bg-muted/30">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <p className="text-muted-foreground text-center max-w-2xl mx-auto mb-12">
            Browse these recently posted valuable items
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <ItemCard 
                item={featuredLostItem} 
                type="lost"
                onContactClick={() => handleItemClick("lost-items")}
              />
            ...
            <div>
              ...
              <ItemCard 
                item={featuredFoundItem} 
                type="found"
                onContactClick={() => handleItemClick("found-items")}
              />
              <div className="mt-4 text-center">
                <Button 
                  variant="outline" 
            ...
            <div>
              ...
              <ItemCard 
                item={featuredDonationItem} 
                type="donation"
                onContactClick={() => handleItemClick("donations")}
              />
              <div className="mt-4 text-center">
                <Button 
                  variant="outline" 
      ...
      <section className="py-12 md:py-24 bg-gradient">
        <div className="container mx-auto px-4 md:px-6 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Start Using Code Commando Today
          </h2>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-8">
            Join our community platform to find your lost valuable items, return found items, and donate what you don't need
          </p>
      ...
      <footer className="bg-gray-50 py-8 mt-auto">
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              <Link to="/" className="flex items-center">
                ...
                <span className="text-xl font-bold text-gray-700">Commando</span>
              </Link>
            </div>
          ...
          <div className="mt-6 text-center text-sm text-gray-500">
            © {new Date().getFullYear()} Code Commando. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
